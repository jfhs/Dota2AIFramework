...
local function BitAND(a,b)--Bitwise and
 ...
 function Dota2AIBot:ParseHeroLevelUp(eHero, result)
 ...
 -- Main entry function --
 function Dota2AIBot:ParseHeroCommand(eHero, result)
...
-- Buying items --
function Dota2AIBot:Buy(eHero, result)
...
function Dota2AIBot:Sell(eHero, result)
...
function Dota2AIBot:UseItem(eHero, result)
	local slot = result.slot
	local eItem = eHero:GetItemInSlot(slot)
	if eItem then
...
function Dota2AIBot:MoveTo(eHero, result)
	AI_ExecuteOrderFromTable({
		UnitIndex = eHero:GetEntityIndex(),
